...
{ id: "polity_dpsp", crumbs: ["AP SI","General Studies","Indian Polity"], kicker: "Indian Polity", title: "DPSP & Fundamental Duties - the full lesson", meta: "Part IV (Art. 36-51) + Part IVA (Art. 51A) - teacher lesson - 30 min - 6 Q topic mock",
  content: `
    <p><b>Start here if you are new.</b> Yesterday you learned rights you can <b>demand in court</b>. Today is the opposite: goals given to the <b>government</b> that no citizen can directly demand, plus duties expected from <b>you</b> that no court directly punishes. Rights are your sword today. DPSP is the government's compass for tomorrow. Duties are your conscience. Exams love this chapter because students mix up which is which.</p>
    <div class="box blue">dY"O <b>Why the split? Cooked food vs seeds.</b> Free India was broke - poor villages, few courts. If jobs, houses and hospitals were all court-rights on day one, courts would drown and the treasury would empty. So leaders split the dream: <b>Part III</b> = urgent freedoms you can enforce now; <b>Part IV (Art. 36-51)</b> = welfare directions governments build as money allows. Borrowed from <b>Ireland</b> (which took it from Spain). <b>Art. 37</b>: DPSP are <b>non-justiciable</b> - no writ for them alone - but <b>fundamental to governance</b>. A hungry man cannot eat seeds today, but without seeds there is no food tomorrow.</div>
    <h3>The three baskets (examiner's favourite sorting game)</h3>
    <table class="rev"><tr><th>Basket</th><th>Articles</th><th>Hook</th></tr>
    <tr><td><b>Socialist</b> - cut rich-poor gap</td><td><span class="art">38, 39, 39A, 41, 42, 43, 43A, 47</span></td><td>Livelihood, shared resources, equal pay, worker health, child care, <b>free legal aid (39A)</b>, maternity, living wage</td></tr>
    <tr><td><b>Gandhian</b> - villages and weak</td><td><span class="art">40, 43, 43B, 46, 47, 48</span></td><td>Panchayats, cottage industry, SC/ST care, nutrition, liquor control, cow and farm protection</td></tr>
    <tr><td><b>Liberal</b> - modern ideas</td><td><span class="art">44, 45, 48A, 49, 50, 51</span></td><td>Common civil code, early care <b>below six</b>, environment, monuments, judiciary separated, world peace</td></tr></table>
    <div class="box green">o. <b>The shield - only TWO clauses.</b> Normally a law breaking an FR dies. But laws genuinely sharing resources and stopping wealth concentration - <span class="art">Art. 39(b)-(c)</span> - get a shield (<span class="art">Art. 31C</span>). Story: 25th Amendment built it (39b-c only) - Kesavananda (1973) kept it but struck its no-court-review tail - 42nd (1976) stretched it to <b>all</b> welfare laws - <b>Minerva Mills (1980) cut it back to 39(b)-(c) only</b>, holding FR-DPSP <b>balance</b> is basic structure. 2024 nine-judge bench: unamended 31C <b>revives</b>, and 39(b) community resources need a real test - <b>not all private property counts</b>. Any other welfare law claiming the shield fails.</div>
    <div class="box blue">dY"O <b>Amendment spine.</b> <b>42nd (1976)</b>: added <span class="art">39A</span> legal aid, <span class="art">43A</span> worker management, <span class="art">48A</span> environment + 10 duties. <b>86th (2002)</b>: ages 6-14 moved OUT of directives into <span class="art">Art. 21A</span> right + <span class="art">51A(k)</span> parent duty; <span class="art">Art. 45</span> now covers <b>below six only</b>. <b>97th (2011)</b>: <span class="art">43B</span> cooperatives.</div>
    <div class="box green">o. <b>Duties - ten plus one.</b> <b>Swaran Singh Committee (1976)</b> proposed, 42nd added 10; 86th added schooling duty. All <b>non-justiciable</b> - but Parliament CAN enforce via laws: flag code, environment fines, schooling law. <b>Verma Committee (1998, report 1999)</b>: operationalise through ~20 existing statutes + teaching. 2024 plea for one duties-punishment code: Court said duties are <b>nurtured, not commanded</b> - no direction to Parliament. Your brother counsels bus-burners in duty-language first: safeguard property, abjure violence.</div>
    <div class="box blue">dY"O <b>Collision rule.</b> Housing law vs owner: courts <b>balance</b>, rights usually win, harmony attempted. Duties never defeat rights. Shield is the ONLY bridge where DPSP beats rights - two clauses wide. Early story: Champakam (1951) FR wins - Kerala Education Bill (advisory) harmony attempt - Minerva balance.</div>
    <div class="takeaway">dYZ_ <b>Six traps:</b> DPSP by writ (false) - Art. 45 covers 6-14 (false, below six) - all welfare shielded (false) - duties directly punishable (false) - 91st/103rd and 42nd/44th swaps - 2024 as total takeover (false). <b>Anchors:</b> SOCIAL 38-43B, GANDHI 40/43/46/47/48, LIBERAL 44/45/48A/49/50/51. Below six directive, six-fourteen right-plus-duty.</div>`,
  questions: [
    { q: "Which statement about Directive Principles is correct?", options: ["Directly enforceable by writs like Fundamental Rights", "Non-justiciable per Art. 37 but fundamental to governance", "Binding only on local bodies", "Added by the 44th Amendment"], answer: 1, explanation: "Art. 37: no writ for DPSP alone, yet fundamental to governance. Borrowed from Ireland. Correct: B." },
    { q: "A law giving effect to Art. 48 (agriculture) claims Art. 31C shield against an Art. 14 challenge. Position after Minerva Mills?", options: ["Shielded: all welfare laws covered", "Not shielded: only true 39(b)-(c) laws after the 1980 cut", "Shielded if Parliament declares it so", "Shielded only during Emergency"], answer: 1, explanation: "Minerva Mills 1980 cut the 42nd-wide shield to 39(b)-(c) only; 2024 bench revived that narrow shield and set a real test for 39(b). Correct: B." },
    { q: "After the 86th Amendment, Art. 45 covers:", options: ["Ages 6-14", "Below age 6 only", "Only college education", "Nothing: Art. 45 deleted"], answer: 1, explanation: "86th (2002) moved 6-14 to Art. 21A right + 51A(k) parent duty; Art. 45 now early childhood below six. Correct: B." },
    { q: "A citizen argues duties under Art. 51A are directly punishable by courts. Correct?", options: ["Yes: writs enforce duties", "No: non-justiciable, enforced only through statutes", "Yes, since the 2024 ruling created a duties code", "No: duties were deleted in 1978"], answer: 1, explanation: "Duties guide laws (Verma 1999: ~20 statutes); 2024 Court refused directing Parliament to a punishment code - duties are nurtured. Correct: B." },
    { q: "Which pairing is WRONG?", options: ["39A legal aid - 42nd Amendment", "43B cooperatives - 97th Amendment", "51A(k) schooling duty - 86th Amendment", "15(6)/16(6) EWS - 91st Amendment"], answer: 3, explanation: "EWS is the 103rd (2019); 91st (2003) caps ministers at 15%. Classic number swap. Correct: D." },
    { q: "In a clash between a welfare land law and Art. 14, courts:", options: ["Always let welfare win", "Balance both; FR-DPSP harmony is basic structure", "Always let the right win fully", "Refer to panchayat"], answer: 1, explanation: "Champakam (FR wins) to Kerala Bill (harmony) to Minerva (balance is basic structure). Correct: B." },
  ] },
